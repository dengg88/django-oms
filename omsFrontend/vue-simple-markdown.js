...
Component.options.__file = "/home/milan/vivify/vue-simple-markdown/src/vue-simple-markdown.component.vue"
...
var IMG_REGEX = /!\[(.*)\]\(((?:(http[s]?|ftp)?:?\/{0,2}).+)\)/g;
  ...
  _createClass(Img, null, [{
    ...
    value: function parse(source) {
      return source.replace(IMG_REGEX, function (match, alt, src) {
        return "<a  class='xxoo' href='" + src +  "' data-lightbox='xxoo" + "' data-title='" + _utils.Utils.escapeQuote(alt) + "'>" + "<img alt='" + _utils.Utils.escapeQuote(alt) + "' src='" + src + "'>" + "</a>";
      });
    }
  }, {
    key: 'RULE_NAME',
